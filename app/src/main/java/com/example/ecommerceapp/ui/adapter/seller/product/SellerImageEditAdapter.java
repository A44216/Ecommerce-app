...
import com.example.ecommerceapp.ui.viewholder.seller.product.SellerImageVH;
import com.example.ecommerceapp.utils.ImageLoader;

import java.util.ArrayList;
import java.util.List;

public class SellerImageEditAdapter extends RecyclerView.Adapter<SellerImageVH> {
    ...
    @NonNull
    @Override
    public SellerImageVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_seller_image_edit, parent, false);
        return new SellerImageVH(view);
    }

    @Override
    public void onViewRecycled(@NonNull SellerImageVH holder) {
        super.onViewRecycled(holder);
        Glide.with(holder.itemView.getContext()).clear(holder.getImgProduct());
    }

    @Override
    public void onBindViewHolder(@NonNull SellerImageVH holder, int position) {
